...
const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
	...
	[SPECIES_APPLIN] =           {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_FLAPPLE, 0}, //IS DEFINED IN ITEMS
								  {EVO_ITEM, ITEM_SWEET_APPLE, SPECIES_APPLETUN, 0}}, //IS DEFINED IN ITEMS
	[SPECIES_SILICOBRA] =        {{EVO_LEVEL, 36, SPECIES_SANDACONDA, 0}},
	[SPECIES_ARROKUDA] =         {{EVO_LEVEL, 26, SPECIES_BARRASKEWDA, 0}},
	[SPECIES_TOXEL] =            {{EVO_LEVEL_CASCOON, 30, SPECIES_TOXTRICITY, 0}, //PERSONALITY VALUES SUBSTITUTE NATURES
	...
	[SPECIES_SINISTEA] =         {{EVO_ITEM, ITEM_CRACKED_POT, SPECIES_POLTEAGEIST, 0}, //IS DEFINED IN ITEMS
	[SPECIES_SINISTEA_CHIPPED] = {{EVO_ITEM, ITEM_CHIPPED_POT, SPECIES_POLTEAGEIST_CHIPPED, 0} //IS DEFINED IN ITEMS
	...
	[SPECIES_MILCERY] =          {{EVO_ITEM, ITEM_STRAWBERRY_SWEET, SPECIES_ALCREMIE_STRAWBERRY, 0}, //IS DEFINED IN ITEMS
								{EVO_ITEM, ITEM_BERRY_SWEET, SPECIES_ALCREMIE_BERRY, 0}, //IS DEFINED IN ITEMS
					       			{EVO_ITEM, ITEM_LOVE_SWEET, SPECIES_ALCREMIE_LOVE, 0}, //IS DEFINED IN ITEMS
								{EVO_ITEM, ITEM_CLOVER_SWEET, SPECIES_ALCREMIE_CLOVER, 0}, //IS DEFINED IN ITEMS
								{EVO_ITEM, ITEM_FLOWER_SWEET, SPECIES_ALCREMIE_FLOWER, 0}, //IS DEFINED IN ITEMS
					  			{EVO_ITEM, ITEM_RIBBON_SWEET, SPECIES_ALCREMIE_RIBBON, 0}, //IS DEFINED IN ITEMS
					   			{EVO_ITEM, ITEM_STAR_SWEET, SPECIES_ALCREMIE_STAR, 0}}, //IS DEFINED IN ITEMS
	...
	[SPECIES_DRAGAPULT] =        {{EVO_LEVEL, 60, SPECIES_DRAGAPULT, 0}},
	[SPECIES_KUBFU] =            {{EVO_LEVEL_CASCOON, 50, SPECIES_URSHIFU_SINGLE, 0}, //PLACEHOLDER
								  {EVO_LEVEL_SILCOON, 50, SPECIES_URSHIFU_RAPID, 0}}, //PLACEHOLDER
	[SPECIES_MEOWTH_G] =         {{EVO_LEVEL, 28, SPECIES_PERRSERKER, 0}},
	[SPECIES_PONYTA_G] =         {{EVO_LEVEL, 40, SPECIES_RAPIDASH_G, 0}},
	[SPECIES_SLOWPOKE_G] =       {{EVO_LEVEL, 37, SPECIES_SLOWBRO_G, 0}, //PLACEHOLDER	 
								  {EVO_ITEM, ITEM_KINGS_ROCK, SPECIES_SLOWKING_G, 0}}, //PLACEHOLDER
	...
	[SPECIES_YAMASK_G] =         {{EVO_LEVEL, 34, SPECIES_RUNERIGUS, 0}}, //UNLESS YOU HAVE ANY BETTER IDEAS
};
