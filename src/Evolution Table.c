...
const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
	...
	[SPECIES_SINIS       {{EVO_ITEM, ITEM_CHIPPED_POT, SPECIES_POLTEAGEIST_CHIPPED, 0} //IS DEFINED IN ITEMS
	[SPECIES_BULBASAUR] =        {{EVO_LEVEL, 16, SPECIES_IVYSAUR, 0}},
	[SPECIES_BULBASAUR] =        {{EVO_LEVEL, 16, SPECIES_IVYSAUR, 0}},
	[SPECIES_BULBASAUR] =        {{EVO_LEVEL, 16, SPECIES_IVYSAUR, 0}},
	[SPECIES_BULBASAUR] =        {{EVO_LEVEL, 16, SPECIES_IVYSAUR, 0}},
	...
	[SPECIES_SLOWPOKE_G] =       {{EVO_LEVEL, 37, SPECIES_SLOWBRO_G, 0}, //PLACEHOLDER FOR NOW	 
