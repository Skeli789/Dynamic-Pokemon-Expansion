...
//	[SPECIES_DURALUDON] =        {{EVO_GIGANTAMAX, TRUE, SPECIES_DURALUDON_GIGA, 0}},
	...
	[SPECIES_KUBFU] =            {{EVO_MOVE_TYPE, TYPE_DARK, SPECIES_URSHIFU_SINGLE, 0},
								  {EVO_MOVE_TYPE, TYPE_WATER, SPECIES_URSHIFU_RAPID, 0}/*,
								  {EVO_NATURE_HIGH, 50, SPECIES_URSHIFU_SINGLE, 0},
								  {EVO_NATURE_LOW, 50, SPECIES_URSHIFU_RAPID, 0}}, 
...
/*	[SPECIES_ALCREMIE_BERRY] =   {{EVO_GIGANTAMAX, TRUE, SPECIES_ALCREMIE_GIGA, 0}},
	...
	[SPECIES_SLOWPOKE_G] =       {{EVO_LEVEL, 37, SPECIES_SLOWBRO_G, 0}, 	 //PLACEHOLDER DATA
								  {EVO_ITEM, ITEM_KINGS_ROCK, SPECIES_SLOWKING_G, 0}}, 
...
/*	[SPECIES_VENUSAUR_GIGA] =    {{EVO_GIGANTAMAX, FALSE, SPECIES_VENUSAUR, 0}},
	...
	[SPECIES_ALCREMIE_GIGA] =    {{EVO_GIGANTAMAX, FALSE, SPECIES_ALCREMIE_STRAWBERRY, 0}}, //Do we need to create more G-Max Alcremies?
