...
#define NATIONAL_DEX_SKWOBET 819
...
extern const u8 DEX_ENTRY_POLTEAGEIST_ANTIQUE[];
extern const u8 DEX_ENTRY_ALCREMIE_VANILLA_CREAM[];
extern const u8 DEX_ENTRY_ALCREMIE_RUBY_CREAM[];
extern const u8 DEX_ENTRY_ALCREMIE_MATCHA_CREAM[];
extern const u8 DEX_ENTRY_ALCREMIE_MINT_CREAM[];
extern const u8 DEX_ENTRY_ALCREMIE_LEMON_CREAM[];
extern const u8 DEX_ENTRY_ALCREMIE_SALTED_CREAM[];
extern const u8 DEX_ENTRY_ALCREMIE_RUBY_SWIRL[];
extern const u8 DEX_ENTRY_ALCREMIE_CARAMEL_SWIRL[];
extern const u8 DEX_ENTRY_ALCREMIE_RAINBOW_SWIRL[];
extern const u8 DEX_ENTRY_EISCUE_NOICE[];
extern const u8 DEX_ENTRY_INDEEDEE_F[];
extern const u8 DEX_ENTRY_MORPEKO_HANGRY[];
extern const u8 DEX_ENTRY_ZACIAN_CROWNED_SWORD[];
extern const u8 DEX_ENTRY_ZAMAZENTA_CROWNED_SHIELD[];
